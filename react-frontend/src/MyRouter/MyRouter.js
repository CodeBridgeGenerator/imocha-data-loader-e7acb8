...
import SingleInvoicePage from "../components/InvoicePage/SingleInvoicePage";
import InvoiceProjectLayoutPage from "../components/InvoicePage/InvoiceProjectLayoutPage";
import SingleMeasurementPage from "../components/MeasurementPage/SingleMeasurementPage";
...
import SingleTaxTypePage from "../components/TaxTypePage/SingleTaxTypePage";
import TaxTypeProjectLayoutPage from "../components/TaxTypePage/TaxTypeProjectLayoutPage";
...
import SingleCountryCodePage from "../components/CountryCodePage/SingleCountryCodePage";
import CountryCodeProjectLayoutPage from "../components/CountryCodePage/CountryCodeProjectLayoutPage";
import SingleStateCodePage from "../components/StateCodePage/SingleStateCodePage";
import StateCodeProjectLayoutPage from "../components/StateCodePage/StateCodeProjectLayoutPage";
import SinglePhoneNumberPrefixPage from "../components/PhoneNumberPrefixPage/SinglePhoneNumberPrefixPage";
import PhoneNumberPrefixProjectLayoutPage from "../components/PhoneNumberPrefixPage/PhoneNumberPrefixProjectLayoutPage";
import SingleCurrencyCodePage from "../components/CurrencyCodePage/SingleCurrencyCodePage";
import CurrencyCodeProjectLayoutPage from "../components/CurrencyCodePage/CurrencyCodeProjectLayoutPage";
import SingleFrequencyOfBillingPage from "../components/FrequencyOfBillingPage/SingleFrequencyOfBillingPage";
import FrequencyOfBillingProjectLayoutPage from "../components/FrequencyOfBillingPage/FrequencyOfBillingProjectLayoutPage";
import SinglePaymentModePage from "../components/PaymentModePage/SinglePaymentModePage";
import PaymentModeProjectLayoutPage from "../components/PaymentModePage/PaymentModeProjectLayoutPage";
...
<Route path="/invoice/:singleInvoiceId" exact element={<SingleInvoicePage />} />
<Route path="/invoice" exact element={<InvoiceProjectLayoutPage />} />
<Route path="/measurement/:singleMeasurementId" exact element={<SingleMeasurementPage />} />
<Route path="/measurement" exact element={<MeasurementProjectLayoutPage />} />
...
<Route path="/taxType/:singleTaxTypeId" exact element={<SingleTaxTypePage />} />
<Route path="/taxType" exact element={<TaxTypeProjectLayoutPage />} />
...
<Route path="/countryCode/:singleCountryCodeId" exact element={<SingleCountryCodePage />} />
<Route path="/countryCode" exact element={<CountryCodeProjectLayoutPage />} />
<Route path="/stateCode/:singleStateCodeId" exact element={<SingleStateCodePage />} />
<Route path="/stateCode" exact element={<StateCodeProjectLayoutPage />} />
...
<Route path="/currencyCode/:singleCurrencyCodeId" exact element={<SingleCurrencyCodePage />} />
<Route path="/currencyCode" exact element={<CurrencyCodeProjectLayoutPage />} />
...
<Route path="/paymentMode/:singlePaymentModeId" exact element={<SinglePaymentModePage />} />
<Route path="/paymentMode" exact element={<PaymentModeProjectLayoutPage />} />
<Route path="/classificationCode/:singleClassificationCodeId" exact element={<SingleClassificationCodePage />} />
<Route path="/classificationCode" exact element={<ClassificationCodeProjectLayoutPage />} />
